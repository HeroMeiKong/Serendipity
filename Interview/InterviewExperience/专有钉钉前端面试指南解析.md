...
1. #### 列举你所了解的计算机存储设备类型？
    ...
    ![计算机存储设备结构图](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/计算机存储设备结构图.png)
...
1. #### 一般代码存储在计算机的哪个设备中？代码在 `CPU` 中是如何运行的？
    ...
    ![计算机 CPU 的简单工作原理](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/计算机CPU的简单工作原理.png)
...
1. #### ℹ️`JavaScript` 是如何运行的？解释型语言和编译型语言的差异是什么？
    ...
    ![基础-5-1](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-5-1.png)
    ...
    ![基础-5-2](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-5-2.png)
    ...
    ![基础-5-3](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-5-3.png)
    ...
    ![基础-5-4](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-5-4.png)
...
1. #### ℹ️什么是交叉编译？
    ...
    ![基础-14-1](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-14-1.png)
    ...
    ![基础-14-2](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-14-2.png)

    由于 `IR` 可以进行多趟迭代进行程序优化，因此在编译器中可插入一个新的优化阶段，如下图所示：

    ![基础-14-3](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-14-3.png)
    ...
    ![基础-14-4](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-14-4.png)
...
1. #### ℹ️发布 / 订阅模式和观察者模式的区别是什么？
    ...
    ![基础-15-1](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-15-1.png)
    ...
    ![基础-15-2](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-15-2.png)
...
1. #### ℹ️什么是函数式编程？什么是响应式编程？什么是函数响应式编程？
    ...
    <br>
      ...
      **假设 `A、B` 是非空数集，对于集合 `A` 中的任意一个数 `x`，在集合 `B` 中都有唯一确定的数 `f(x)` 和它对应，那么可以将 `f` 称为从 `A` 到 `B` 的一个函数，记作：`y = f(x)`。在函数式编程中函数的概念和数学函数的概念类似，主要是描述形参 `x` 和返回值 `y` 之间的对应关系**，如下图所示：
      ...
      ![基础-20-1](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/基础-20-1.png)
