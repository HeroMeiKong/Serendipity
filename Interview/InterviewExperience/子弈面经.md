...
1. ### 讲讲 `MVVM`，说说与 `MVC` 有什么区别
    ...
    - `MVC`（`Model-View-Controller`）
      ...
      ![MVC](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/zymj/mvc.awebp)
    ...
    - `MVVM`（`Model-View-ViewModel`)
      ...
      ![MVC](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/zymj/mvvm.awebp)
...
1. ### 说说 `z-index` 有什么需要注意的地方
    ...
    可能面试官最想知道的是下面这张图：
    ![z-index 层级](https://raw.githubusercontent.com/HeroMeiKong/Images/main/Serendipity/Interview/InterviewExperience/zymj/阿里CBU-z-index层级.awebp)
